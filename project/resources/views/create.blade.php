            ...
            <div class="box-body">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input name="longitude" value="{{old('longitude')}}" type="text" class="form-control" id="exampleInputEmail1" placeholder="Формат: 54.205973">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Введите координаты организации (широта)</label>
                        <input name="latitude" value="{{old('latitude')}}" type="text" class="form-control" id="exampleInputEmail1" placeholder="Формат: 49.6033793">
                    </div>
                    <div class="form-group">
